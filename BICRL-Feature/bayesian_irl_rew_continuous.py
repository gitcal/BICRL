...
class BIRL:
    ...
    def generate_proposal(self, W_old, stdev=0.1):
        ...
        # IPython.embed()
        W_new[index] =  W_old[index] + stdev * np.random.randn() 
    ...
    def initial_proposal(self):
        ...
        W_new = -5*np.random.rand(self.env.num_features)#
    ...
    def run_mcmc_bern_constraint(self, samples, W_fix, stdev):
        ...
        for i in range(num_samples):
            ...
            prop_W_add = self.generate_proposal(cur_W_add, stdev)
    ...
    def get_mean_solution(self, burn_frac=0.1, skip_rate=1):
        ...
        mean_rew = np.mean(self.chain_W, axis=0)
