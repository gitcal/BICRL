from mdp import HighwayMDP_test, HighwayMDP, MDP
import numpy as np
import IPython
...
def highway_test(rows, columns, terminals, rewards, constraints, gamma, noise):
    """
    Randomly chooses rewards, no terminal, noisy transition
    """
    mdp = HighwayMDP_test(rows, columns, terminals, rewards, constraints=None, gamma=0.95, noise = 0.1)
    return mdp
