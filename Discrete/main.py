...
if __name__ == "__main__":
    ...
    for exp in [1,2]:
        for kkk in range(10):
            ...
            cur_constr, cur_rew = birl.initial_solution_bern_cnstr()
            ...
            for kk in range(20):
                ...
                if kk==0:
                    prop_constr, prop_rew = cur_constr, cur_rew
                    num_steps = 4000
                else:
                    prop_constr, prop_rew = birl.prop_constr, birl.prop_rew
                    num_steps = 1000
              
                birl = bayesian_irl.BIRL(env2, trajectory_demos, boltz_beta, env_orig, prop_constr, prop_rew)
                ...
                if exp ==2:
                    temp_query_state = np.random.randint(1,nx * ny)
                else:
                    temp_query_state = birl.compute_variance(birl.posterior, 0.1)
